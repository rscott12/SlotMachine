...
//  SlotMachine
//
//  Created by Raymond Scott on 10/13/14.
...
class ViewController: UIViewController
{
    ...
    func setupThirdContainer (containerView: UIView)
    {
        ...
        self.winnerPaidLabelTitleLabel = UILabel()
        self.winnerPaidLabelTitleLabel.text = "Winner Paid"
        self.winnerPaidLabelTitleLabel.textColor = UIColor.blackColor()
        self.winnerPaidLabelTitleLabel.font = UIFont(name: "AmericanTypewriter", size: 14)
    ...
    func setupFourthContainer (containerView: UIView)
    {
        ...
        self.betOneButton.addTarget(self, action: "betButtonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
